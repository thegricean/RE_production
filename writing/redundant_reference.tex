...
\midrule
Size of lexicon $\mathcal{L}(u,o)$  & 8 (all combinations of \emph{size}, \emph{color}, \emph{othersize}, and \emph{othercolor}) & 1491 (1 for each $u,o$ combination) \jd{elisa, can you check total lexicon size?} & \jd{XXX} (1 for each $u,o$ combination)\\
\midrule
