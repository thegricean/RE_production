...
%This supports the view of a language production system geared towards communicative efficiency.
...
We have provided an overview of the RSA models evaluated for the three reported production datasets in \tableref{tab:modeldiffs}. \ndg{we really need to say more here about the diversity of models. at the moment this big table just makes it look like we did a bunch of post-hoc model tweaking and really weakens our case. probably a small subsection? basically we need to comment on the differences, why they were made, and how they aren't really substantive (we hope).}
