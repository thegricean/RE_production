...
\begin{table}[bt!]
	...
	\end{tabular}
	\vspace{2mm}
	\caption{Overview of typicality norming studies; the value in brackets shows the number of items including \textit{fruit}, \textit{vegetable} and \textit{cup}. \jd{elisa, can you say in the main body what an "item" is?}}
...
\midrule
Size of lexicon & 8 & 1491 \jd{elisa, can you check total lexicon size?} & \jd{XXX} \\
\midrule
