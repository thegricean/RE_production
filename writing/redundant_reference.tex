...
\title{A Bayesian approach to redundancy in reference
%\ndg{consider alternatives: "rationally redundant referring expressions", "A Bayesian approach to redundancy in reference", Over `overinformativeness': rationally redundant referring expressions }
}
...
\textbf{Keywords:} 
experimental pragmatics; probabilistic pragmatics; reference; referring expressions; informativeness; overinformativeness; adjectives
\end{abstract}
...
\caption{Scatterplot of empirical utterance proportions against point-wise maximum a posteriori (MAP) estimates of the RSA model's posterior predictives.}
