...
RSA with a continuous semantics thus captures the qualitative effects of color-size asymmetry and scene variation in production of redundant expressions. A more quantitative test of the model requires more data. 
