...
\multirow{3}{*}{Cost} & \emph{empirical} & -1474.6 () & -1354.4 () \\
 ...
 & \emph{none} & -1372.9 () & \textbf{-1209.8 ()} \\ 
\bottomrule
\end{tabular}
\label{tab:exp2-modelcomparison}
\end{table}

Posteriors over parameters for the best model are shown in \figref{fig:typparamposteriors}. \jd{XXX discuss once file available for plotting}
...
A scatterplot of empirical utterance proportions agains model predictions are shown in \figref{fig:typpredictives}. \jd{XXX discuss once file available for plotting}
