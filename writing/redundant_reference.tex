...
\ndg{can we talk about less close to 1 as "noisier"? haven't introduced that yet...}
...
\ndg{this all does feel like it wants discussion of noise... need to introduce the non-deterministic interpretation somewhere above?}
