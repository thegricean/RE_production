...
d = read.table(file=here("data","norming_1.csv"),sep=",", header=T)#, quote="")
d1 = read.table(file=here("data","norming_2.csv"),sep=",", header=T)#, quote="")
...
d2_0 = read.table(file=here("data","norming_3","norming0.csv"),sep=",", header=T)#, quote="")
d2_1 = read.table(file=here("data","norming_3","norming1.csv"),sep=",", header=T)
d2_2 = read.table(file=here("data","norming_3","norming2.csv"),sep=",", header=T)
d2_3 = read.table(file=here("data","norming_3","norming3.csv"),sep=",", header=T)
