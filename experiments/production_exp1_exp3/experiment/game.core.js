...
var getRandomizedConditions = function() {
  ...
  var conds = [].concat(
    utils.fillArray({type: "basic", d1Level: 1, d2Level: 2}, 9),
    utils.fillArray({type: "basic", d1Level: 2, d2Level: 2}, 9),
    utils.fillArray({type: "basic", d1Level: 2, d2Level: 3}, 9),
    utils.fillArray({type: "basic", d1Level: 3, d2Level: 3}, 9)
  );

  // Add color/size trials
  _.forEach(["color", "size"], function(type) {
